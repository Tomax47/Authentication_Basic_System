...
class BlogpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogpost" do
    assert_difference("Blogpost.count") do
      post blogposts_url, params: { blogpost: { aouther: @blogpost.aouther, content: @blogpost.content, publish_date: @blogpost.publish_date, title: @blogpost.title } }
    end
  ...
  test "should update blogpost" do
    patch blogpost_url(@blogpost), params: { blogpost: { aouther: @blogpost.aouther, content: @blogpost.content, publish_date: @blogpost.publish_date, title: @blogpost.title } }
